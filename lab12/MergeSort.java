...
public class MergeSort {
     ...
     */
    static <Item extends Comparable> Queue<Queue<Item>> makeSingleItemQueues(
        Queue<Item> items) {
     ...
     * greatest.
     */
    static <Item extends Comparable> Queue<Item> mergeSortedQueues(
        Queue<Item> q1, Queue<Item> q2) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Original queue: " + students.toString());
        System.out.println("Sorted queue: " + sortedstudents.toString());
